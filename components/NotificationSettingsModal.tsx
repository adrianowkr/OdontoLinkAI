            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md flex flex-col transform transition-all duration-300 scale-95 opacity-0 animate-fade-in-scale">
                <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center">
                        ...
                        <h2 className="ml-2 text-lg font-bold text-gray-800 dark:text-white">Gerenciar Notificações</h2>
                    </div>
                ...
                <div className="p-6 text-center">
                    <p className="text-gray-600 dark:text-gray-300">As configurações detalhadas de notificação (e-mail, push, etc.) estariam aqui.</p>
                </div>
